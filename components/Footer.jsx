...
const Footer = () => {
  ...
  const [modalStyle1] = useState(getModalStyle1);
  ...
  const body = (
    <div style={modalStyle1} className={classes.paper}>
      <h2 id="simple-modal-title1">Terms of Use</h2>
      <div id="simple-modal-description1">
        <div>
          <h2>Universal Acting Terms of Use</h2>

          <p>Version 1.0</p>

          <p>
            The Universal Acting website located at www.universalacting.com is a
            copyrighted work belonging to Universal Acting. Certain features of
          ...
          <p>
            ...
            not represent or imply to others that your User Content is in any
            way provided, sponsored or endorsed by Company. Because you alone
          ...
          <p>
            ...
            to collect, upload, transmit, display, or distribute any User
          ...
          <p>
            ...
            on any of the Third-Party Links & Ads, the applicable third partys
            terms and policies apply, including the third partys privacy and
          ...
          <p>
            ...
            Universal Acting uses cookies. These cookies are used to store
          ...
          <p>
            The site is provided on an as-i and as available basis, and company
          ...
          <p>
            ...
            posting notice of the changes on our Sit You are responsible for
            providing us with your most current e-mail addres In the event that
            ...
            constitute effective notice of the changes described in the notic
            ...
            of the changes on our Sit These changes will be effective
            immediately for new users of our Sit Continued use of our Site
            ...
            Company and affects your right It contains procedures for MANDATORY
          ...
          <p>
            ...
            to the Company should be sent to: 6454 Northeast 4TH Avenue. After
          ...
          <p>
            ...
            partys patent, copyright, trademark or trade secrets shall not be
          ...
          <p>
            ...
            by you without Companys prior written consent, and any attempted
          ...
          <p>Address: 6454 Northeast 4TH Avenue</p>
          <p>Email: universalactinginfo@gmail.com</p>
        </div>
      </div>
    </div>
  );
  ...
  const body2 = (
    <div style={modalStyle2} className={classes.paper}>
      <h2 id="simple-modal-title2">Privacy Policy And Cookies</h2>
      <div id="simple-modal-description2">
        <div>
          <h1>Privacy Policy for Universal Acting</h1>

          <p>
            At Universal Acting, accessible from www.universalacting.com, one of
            our main priorities is the privacy of our visitors. This Privacy
            Policy document contains types of information that is collected and
            recorded by Universal Acting and how we use it.
          </p>
          ...
          <p>
            Universal Acting follows a standard procedure of using log files.
          ...
          <p>
            Like any other website, Universal Acting uses cookies. These cookies
          ...
          <p>
            ...
            advertising partners of Universal Acting.
          </p>

          <p>
            Third-party ad servers or ad networks uses technologies like
            cookies, JavaScript, or Web Beacons that are used in their
            respective advertisements and links that appear on Universal Acting,
          ...
          <p>
            Note that Universal Acting has no access to or control over these
          ...
          <p>
            Universal Actings Privacy Policy does not apply to other advertisers
          ...
          <p>
            Universal Acting does not knowingly collect any Personal
  ...
  return (
    <div className={styles.contfood}>
      ...
      <div className={styles.contfood__maps}>
        <div>
          <h5 className={styles.contfood__maps__title}>Hollywood</h5>
          <p className={styles.contfood__maps__dir}>(786) 291-0287</p>
          <iframe
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3585.8295592185746!2d-80.1509772888062!3d26.00640009835519!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x88d9ab9ead256723%3A0x36d47a7e88bf479e!2s601%20S%2021st%20Ave%2C%20Hollywood%2C%20FL%2033020%2C%20EE.%20UU.!5e0!3m2!1ses!2sco!4v1740758262758!5m2!1ses!2sco"
            loading="lazy"
      ...
      <div className={styles.contfood__down__terms}>
        {/* <Link href="/terms" passHref>
          <p className={styles.contfood__down__terms__item} onClick={handleOpen}>Terms of Use</p>
        </Link> */}
        <div>
          <p
            className={styles.contfood__down__terms__item}
            onClick={handleOpen1}
          >
            Terms of Use
          </p>
